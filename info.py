...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002368149367'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+yjPreOueV01iNmY1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', 'https://t.me/movie_hub_hd_hindi').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002368149367')) # The movie you upload in it will be deleted from the bot.
